...
<head>
    ...
    <title>Knowledge Base &middot; ProjectFlow AI</title>
    ...
    <div class="min-h-screen flex flex-col">
        <header class="border-b border-gray-200 bg-white">
            <div class="max-w-5xl mx-auto px-8 py-5 flex items-center justify-between">
                <div>
                    ...
                    <span class="block text-xs text-gray-400">Knowledge Base</span>
                </div>
            </div>
        </header>
        ...
        <main class="flex-1">
            <div class="max-w-5xl mx-auto px-8 py-8">
                ...
                <div class="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4" x-data="knowledgeUploader()">
